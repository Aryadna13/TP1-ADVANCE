...
@TestLogInExitoso @LogInWhitEmail @Smoke
Scenario: Puedo loguearme con un e-mail no guardado
When ingreso un e-mail valido registrado
And clickeo sobre el boton "CONTINUE WITH EMAIL"
Then aparece un cartel pidiendo ingresar un codigo valido enviado al email usado 

@TestLogInExitoso @LogInWhitEmail
Scenario:Puedo loguearme con un e-mail relacionado a Google
When clickeo "Continue with Google"
And elijo el email de mi cuenta de Google
Then soy redirigido la pagina principal de clockify
